...
{
    public class ThirdPersonShoulderCameraStrategy : ICameraModeCalculationStrategy
    {
        public CameraMode Mode => CameraMode.ThirdPersonShoulder;
    ...
    // 하위 호환 별칭
    public class ShoulderCameraStrategy : ThirdPersonShoulderCameraStrategy
    {
    }
}
